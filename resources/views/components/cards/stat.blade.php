...
{{-- 
    If you dont put label and amount within the props they will be displayed in the browser in the attributes section.
--}}

<div class="bg-white shadow rounded-lg p-4 flex items-center {{ $attributes }}">
    <div class="{{ $colorClasses[$color]['bg'] }} p-3 rounded-full">
        <svg class="size-8 {{ $colorClasses[$color]['text'] }}" stroke-width="1.5" stroke="currentColor" fill="none" viewBox="0 0 24 24">
