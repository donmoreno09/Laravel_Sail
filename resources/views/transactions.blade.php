...
@section('header')
    ...
    <div class="w-full py-3 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
            ...
            <x-cards.stat label="Total Income" amount="50000"/>
            <x-cards.stat label="Total Expense" amount="45000"/>
            <x-cards.stat label="Net Savings" amount="5000"/>
            <x-cards.stat label="Goal" amount="7500"/>
            
            {{-- Uncomment the following blocks if you want to display them --}}    
